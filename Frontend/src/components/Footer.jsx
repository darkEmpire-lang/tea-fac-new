    ...
    <footer className="py-10">
      ...
      <div className="container mx-auto flex flex-col sm:flex-row sm:justify-between items-center sm:items-start gap-10 px-5">
        ...
        <div className="flex flex-col items-center sm:items-start">
          <img className="w-32 mb-4" src={assets.flogo} alt="Company Logo" />
        ...
        <div className="flex flex-col items-center sm:items-start">
          ...
          <ul className="flex flex-col gap-2 text-gray-600">
            ...
            <li className="hover:text-gray-800 cursor-pointer">contact@craftopia.com</li>
          </ul>
        </div>
      </div>
      ...
      <div className="mt-10 border-t border-gray-300 pt-5">
        <p className="text-sm text-gray-600 text-center">
          Copyright © 2025 craftopia.lk  All rights reserved.
        </p>
      </div>
    </footer>
  );
